<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="heroku_docker_test.Index" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    ...
                    <div class="btn-group-vertical custom_btn">
                        <a href="#" class="btn btn-rabbit _active" >About</a>
                        <a href="#" class="btn btn-rabbit">Work</a>
                        <a href="contact.aspx" class="btn btn-rabbit">Contact</a>
                    </div>
                    <div class="social">
